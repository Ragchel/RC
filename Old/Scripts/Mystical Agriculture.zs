...
recipes.remove(StoneSeeds); recipes.remove(ZombieSeeds); recipes.remove(NetherSeeds); recipes.remove(PigSeeds); recipes.remove(DyeSeeds); recipes.remove(FireSeeds); recipes.remove(CoalSeeds); recipes.remove(SlimeSeeds); recipes.remove(SheepSeeds);
recipes.remove(CowSeeds); recipes.remove(ChickenSeeds); recipes.remove(CopperSeeds); recipes.remove(AluminumSeeds); recipes.remove(SulfurSeeds); recipes.remove(<mysticalagriculture:aluminum_brass_seeds>); recipes.remove(GoldSeeds); recipes.remove(ObsidianSeeds);
recipes.remove(RedstoneSeeds); recipes.remove(QuartzSeeds); recipes.remove(IronSeeds); recipes.remove(RabbitSeeds); recipes.remove(GuardianSeeds); recipes.remove(SkeletonSeeds); recipes.remove(CreeperSeeds); recipes.remove(SpiderSeeds); recipes.remove(SilverSeeds);
recipes.remove(BrassSeeds); recipes.remove(BronzeSeeds); recipes.remove(TinSeeds); recipes.remove(SaltPeterSeeds); recipes.remove(InvarSeeds); recipes.remove(ElectrumSeeds); recipes.remove(ConstantanSeeds); recipes.remove(NickelSeeds); recipes.remove(SteelSeeds);
recipes.remove(LeadSeeds); recipes.remove(KnightSlimeSeeds); recipes.remove(BasalzSeeds); recipes.remove(BlitzSeeds); recipes.remove(BlizzSeeds); recipes.remove(<mysticalagriculture:grains_of_infinity_seeds>); recipes.remove(<mysticalagriculture:silicon_seeds>);
recipes.remove(ArditeSeeds); recipes.remove(BlackQuartzSeeds); recipes.remove(ThaumiumSeeds); recipes.remove(QuickSilverSeeds); recipes.remove(EndSeeds); recipes.remove(<mysticalagriculture:malachite_seeds>); recipes.remove(GlowstoneSeeds); recipes.remove(ExpSeeds);
recipes.remove(LapisSeeds); recipes.remove(EndermanSeeds); recipes.remove(GhastSeeds); recipes.remove(BlazeSeeds); recipes.remove(MithrilSeeds); recipes.remove(LumiumSeeds); recipes.remove(SignalumSeeds); recipes.remove(AmberSeeds); recipes.remove(CobaltSeeds); 
recipes.remove(VoidMetalSeeds); recipes.remove(<mysticalagriculture:fluix_seeds>); recipes.remove(DiamondSeeds); recipes.remove(EmeraldSeeds); recipes.remove(WitherSkeletonSeeds); recipes.remove(IridiumSeeds); recipes.remove(PlatinumSeeds);
recipes.remove(EnderiumSeeds); recipes.remove(ManyullynSeeds); recipes.remove(RubberSeeds); recipes.remove(<mysticalagriculture:dark_steel_seeds>); recipes.remove(<mysticalagriculture:topaz_seeds>); recipes.remove(<mysticalagriculture:ruby_seeds>);
recipes.remove(<mysticalagriculture:sapphire_seeds>); recipes.remove(<mysticalagriculture:peridot_seeds>); recipes.remove(<mysticalagriculture:osmium_seeds>); recipes.remove(<mysticalagriculture:uranium_seeds>); recipes.remove(<mysticalagriculture:uranium_238_seeds>);
recipes.remove(<mysticalagriculture:iridium_ore_seeds>); recipes.remove(<mysticalagriculture:glowstone_ingot_seeds>); recipes.remove(<mysticalagriculture:refined_obsidian_seeds>); recipes.remove(<mysticalagriculture:electrotine_seeds>);
recipes.remove(<mysticalagriculture:alumite_seeds>);recipes.remove(<mysticalagradditions:dragon_egg_seeds>); recipes.remove(<mysticalagradditions:nether_star_seeds>); recipes.remove(<mysticalagriculture:end_steel_seeds>); recipes.remove(<mysticalagriculture:electrical_steel_seeds>);
recipes.remove(<mysticalagriculture:tanzanite_seeds>); recipes.remove(<mysticalagriculture:conductive_iron_seeds>); recipes.remove(<mysticalagriculture:redstone_alloy_seeds>); recipes.remove(<mysticalagriculture:soularium_seeds>);
recipes.remove(<mysticalagriculture:pulsating_iron_seeds>); recipes.remove(<mysticalagriculture:energetic_alloy_seeds>); recipes.remove(<mysticalagriculture:vibrant_alloy_seeds>); recipes.remove(<mysticalagriculture:mystical_flower_seeds>);
recipes.remove(<mysticalagriculture:manasteel_seeds>); recipes.remove(<mysticalagriculture:elementium_seeds>); recipes.remove(<mysticalagriculture:terrasteel_seeds>); recipes.remove(<mysticalagriculture:apatite_seeds>);
recipes.remove(<mysticalagriculture:steeleaf_seeds>); recipes.remove(<mysticalagriculture:ironwood_seeds>); recipes.remove(<mysticalagriculture:knightmetal_seeds>); recipes.remove(<mysticalagriculture:fiery_ingot_seeds>);
recipes.remove(<mysticalagriculture:slimy_bone_seeds>); recipes.remove(<mysticalagriculture:syrmorite_seeds>); recipes.remove(<mysticalagriculture:octine_seeds>); recipes.remove(<mysticalagriculture:valonite_seeds>); recipes.remove(<mysticalagriculture:ender_amethyst_seeds>); recipes.remove(<mysticalagriculture:sky_stone_seeds>); recipes.remove(<mysticalagriculture:certus_quartz_seeds>);
...
recipes.addShaped(<mysticalagriculture:mystical_flower_seeds>,[[<mysticalagriculture:crafting:10>, Pr, <mysticalagriculture:crafting:10>],[Pr, ST2, Pr],[<mysticalagriculture:crafting:10>, Pr, <mysticalagriculture:crafting:10>]]);
recipes.addShaped(<mysticalagriculture:apatite_seeds>,[[<forestry:apatite>, Pr, <forestry:apatite>],[Pr, ST2, Pr],[<forestry:apatite>, Pr, <forestry:apatite>]]);
recipes.addShaped(<mysticalagriculture:slimy_bone_seeds>,[[<thebetweenlands:items_misc:14>, Pr, <thebetweenlands:items_misc:14>],[Pr, ST2, Pr],[<thebetweenlands:items_misc:14>, Pr, <thebetweenlands:items_misc:14>]]);
...
recipes.addShaped(<mysticalagriculture:electrical_steel_seeds>,[[<enderio:item_alloy_ingot:0>, It, <enderio:item_alloy_ingot:0>],[It, ST3, It],[<enderio:item_alloy_ingot:0>, It, <enderio:item_alloy_ingot:0>]]);
recipes.addShaped(<mysticalagriculture:redstone_alloy_seeds>,[[<enderio:item_alloy_ingot:3>, It, <enderio:item_alloy_ingot:3>],[It, ST3, It],[<enderio:item_alloy_ingot:3>, It, <enderio:item_alloy_ingot:3>]]);
recipes.addShaped(<mysticalagriculture:conductive_iron_seeds>,[[<enderio:item_alloy_ingot:4>, It, <enderio:item_alloy_ingot:4>],[It, ST3, It],[<enderio:item_alloy_ingot:4>, It, <enderio:item_alloy_ingot:4>]]);
recipes.addShaped(<mysticalagriculture:manasteel_seeds>,[[<botania:manaresource:0>, It, <botania:manaresource:0>],[It, ST3, It],[<botania:manaresource:0>, It, <botania:manaresource:0>]]);
recipes.addShaped(<mysticalagriculture:steeleaf_seeds>,[[<twilightforest:steeleaf_ingot>, It, <twilightforest:steeleaf_ingot>],[It, ST3, It],[<twilightforest:steeleaf_ingot>, It, <twilightforest:steeleaf_ingot>]]);
recipes.addShaped(<mysticalagriculture:ironwood_seeds>,[[<twilightforest:ironwood_ingot>, It, <twilightforest:ironwood_ingot>],[It, ST3, It],[<twilightforest:ironwood_ingot>, It, <twilightforest:ironwood_ingot>]]);
recipes.addShaped(<mysticalagriculture:syrmorite_seeds>,[[<thebetweenlands:items_misc:11>, It, <thebetweenlands:items_misc:11>],[It, ST3, It],[<thebetweenlands:items_misc:11>, It, <thebetweenlands:items_misc:11>]]);
recipes.addShaped(<mysticalagriculture:octine_seeds>,[[<thebetweenlands:octine_ingot>, It, <thebetweenlands:octine_ingot>],[It, ST3, It],[<thebetweenlands:octine_ingot>, It, <thebetweenlands:octine_ingot>]]);
recipes.addShaped(<mysticalagriculture:sky_stone_seeds>,[[<appliedenergistics2:sky_stone_block>, It, <appliedenergistics2:sky_stone_block>],[It, ST3, It],[<appliedenergistics2:sky_stone_block>, It, <appliedenergistics2:sky_stone_block>]]);
recipes.addShaped(<mysticalagriculture:certus_quartz_seeds>,[[<appliedenergistics2:material:0>, It, <appliedenergistics2:material:0>],[It, ST3, It],[<appliedenergistics2:material:0>, It, <appliedenergistics2:material:0>]]);
...
recipes.addShaped(<mysticalagriculture:tanzanite_seeds>,[[<biomesoplenty:gem:4>, Su, <biomesoplenty:gem:4>],[Su, ST4, Su],[<biomesoplenty:gem:4>, Su, <biomesoplenty:gem:4>]]);
recipes.addShaped(<mysticalagriculture:soularium_seeds>,[[<enderio:item_alloy_ingot:7>, Su, <enderio:item_alloy_ingot:7>],[Su, ST4, Su],[<enderio:item_alloy_ingot:7>, Su, <enderio:item_alloy_ingot:7>]]);
recipes.addShaped(<mysticalagriculture:pulsating_iron_seeds>,[[<enderio:item_alloy_ingot:5>, Su, <enderio:item_alloy_ingot:5>],[Su, ST4, Su],[<enderio:item_alloy_ingot:5>, Su, <enderio:item_alloy_ingot:5>]]);
recipes.addShaped(<mysticalagriculture:energetic_alloy_seeds>,[[<enderio:item_alloy_ingot:1>, Su, <enderio:item_alloy_ingot:1>],[Su, ST4, Su],[<enderio:item_alloy_ingot:1>, Su, <enderio:item_alloy_ingot:1>]]);
...
recipes.addShaped(<mysticalagriculture:knightmetal_seeds>,[[<twilightforest:knightmetal_ingot>, Su, <twilightforest:knightmetal_ingot>],[Su, ST4, Su],[<twilightforest:knightmetal_ingot>, Su, <twilightforest:knightmetal_ingot>]]);
recipes.addShaped(<mysticalagriculture:fiery_ingot_seeds>,[[<twilightforest:fiery_ingot>, Su, <twilightforest:fiery_ingot>],[Su, ST4, Su],[<twilightforest:fiery_ingot>, Su, <twilightforest:fiery_ingot>]]);
...
recipes.addShaped(<mysticalagradditions:dragon_egg_seeds>,[[<mysticalagradditions:stuff:2>, Sr, <mysticalagradditions:stuff:2>],[Sr, <mysticalagradditions:tier_6_crafting_seed>, Sr],[<mysticalagradditions:stuff:2>, Sr, <mysticalagradditions:stuff:2>]]);
recipes.addShaped(<mysticalagradditions:nether_star_seeds>,[[<minecraft:nether_star>, Sr, <minecraft:nether_star>],[Sr, <mysticalagradditions:tier_6_crafting_seed>, Sr],[<minecraft:nether_star>, Sr, <minecraft:nether_star>]]);
recipes.addShaped(<mysticalagriculture:end_steel_seeds>,[[<enderio:item_alloy_ingot:8>, Sr, <enderio:item_alloy_ingot:8>],[Sr, ST5, Sr],[<enderio:item_alloy_ingot:8>, Sr, <enderio:item_alloy_ingot:8>]]);
recipes.addShaped(<mysticalagriculture:vibrant_alloy_seeds>,[[<enderio:item_alloy_ingot:2>, Sr, <enderio:item_alloy_ingot:2>],[Sr, ST5, Sr],[<enderio:item_alloy_ingot:2>, Sr, <enderio:item_alloy_ingot:2>]]);
...
recipes.addShaped(<mysticalagriculture:ender_amethyst_seeds>,[[<biomesoplenty:gem:0>, Sr, <biomesoplenty:gem:0>],[Sr, ST5, Sr],[<biomesoplenty:gem:0>, Sr, <biomesoplenty:gem:0>]]);
recipes.addShaped(<mysticalagriculture:valonite_seeds>,[[<thebetweenlands:items_misc:19>, Sr, <thebetweenlands:items_misc:19>],[Sr, ST5, Sr],[<thebetweenlands:items_misc:19>, Sr, <thebetweenlands:items_misc:19>]]);
