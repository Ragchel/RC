print ("Starting Nerfing ProjectEX");
...
recipes.remove (CMK1); recipes.remove (CMK2); recipes.remove (CMK3); recipes.remove (<projectex:collector:3>);
...
print ("Finished Nerfing ProjectEX");